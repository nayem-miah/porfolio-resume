...
export default function Sidebar() {
  ...
  return (
    <>
      <div className={`sidebar fixed ${sidebar} top-0 z-[999] h-screen w-full bg-btn/60 transition-all duration-500`}>
        <div className="ml-auto h-screen w-[300px] bg-white px-[30px] pt-[60px] dark:bg-card">
          <div className="relative flex justify-center">
            <button onClick={()=>setSidebar('left-[100%]')} className="group absolute left-[-78px] rounded-lg bg-white px-[15px] py-[10px] text-[26px] dark:bg-card">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
